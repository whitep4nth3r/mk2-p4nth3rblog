...
const ContentfulBlogPosts = {
  ...
  getPaginated: async function (page) {
    ...
    const variables = { skip, limit: queryLimit, preview: true };

    const query = `query GetPaginatedSlugs($limit: Int!, $skip: Int!, $preview: Boolean!) {
        blogPostCollection(limit: $limit, skip: $skip, order: date_DESC, preview: $preview) {
          total
          items {
            sys {
              id
              ...
              links {
                entries {
                  ...
                  block {
                    ...
                    ${GraphQLStringBlocks.tikTokEmbed()}
  ...
  getPaginatedSummaries: async function (page) {
    ...
    const variables = { skip, limit: Config.pagination.pageSize, preview: true };

    const query = `query GetPaginatedSummaries($skip: Int!, $limit: Int!, $preview: Boolean!) {
        blogPostCollection(limit: $limit, skip: $skip, order: date_DESC, preview: $preview) {
          total
          items {
            sys {
