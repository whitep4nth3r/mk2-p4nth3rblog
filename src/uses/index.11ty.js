...
const pageTitle = "What whitep4nth3r uses for coding and streaming";
  ...
  return /* html */ `
    <section class="page__index">
      <div class="twoColumn__header">
        <h1 class="twoColumn__headerTitle">Things I use</h1>
      </div>
      ...
      <div class="twoColumn">
        ...
        <div class="twoColumn__content">
          ...
          ${PageBanner({
            title: "Coding & streaming setup",
            copy: "I receive a lot of questions on stream about my setup and what I use. Here's a (very incomplete) list to make it easier to share.",
          })}
