...
function homeAbout({ person }) {
  ...
  <div class="homeAbout">
    ...
    <h2 class="homeAbout__subtitle">Staff Developer Experience Engineer at <a href="http://www.netlify.com?utm_campaign=devex-san&utm_source=whitep4nth3r-blog&utm_content=netlify-home" target="_blank">Netlify</a></h2>
