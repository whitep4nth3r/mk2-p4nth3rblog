...
function BlogSidebarAuthor({ author, isLive }) {
  const buttonText = isLive ? "Watch me live" : "Follow on Twitch";
  ...
  <div class="blogSidebarAuthor">
    ...
    ${isLive ? '<span class="home__item__onAir">ON AIR</span>' : ""}

    <div class="blogSidebarAuthor__cta2">
      <p class="blogSidebarAuthor__cta2__text">✨ I write code ✨<br />for your entertainment</p>
